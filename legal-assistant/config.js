...
module.exports = {
    // The API key needs to be a regular OpenAI API key (starts with sk-) not a project key
    openaiApiKey: 'sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', // Replace with a valid OpenAI API key
    ...
    fallbackEnabled: true // Whether to use local knowledge base if OpenAI fails
}; 